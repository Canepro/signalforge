...
# Do not commit real host labels, token paths, or tokens here.

set -euo pipefail

SOURCE_IDENTIFIER="${SIGNALFORGE_SOURCE_IDENTIFIER:-linux:<host-label>}"
ARTIFACT_FAMILY="linux-audit-log"
TOKEN_FILE="${SIGNALFORGE_TOKEN_FILE:-/var/lib/signalforge/automation-agent-token-linux-host}"

...
The repo-supported durable remote Postgres path uses Neon Postgres. Local development, Vercel previews, and the ACA app path may use different app hosts while keeping the same Postgres posture.

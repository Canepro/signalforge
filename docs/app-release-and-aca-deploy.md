...
- `ACA_APP_CODEX_APP_SERVER_TRANSPORT`
- `ACA_APP_CODEX_APP_SERVER_MODEL`
- `ACA_APP_CODEX_APP_SERVER_TURN_TIMEOUT_MS`
- `ACA_APP_CODEX_APP_SERVER_WS_URL`
- `ACA_APP_CODEX_APP_SERVER_WS_ALLOW_REMOTE`

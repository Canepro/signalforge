...
- optional `SIGNALFORGE_AUTOMATION_AGENT_TOKEN_<SOURCE_SLUG>` — source-bound automation-agent token; see [`operators/selene-multi-source-enrollment.md`](./operators/selene-multi-source-enrollment.md)

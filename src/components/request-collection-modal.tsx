            ...
            >
              <label className="block">
                ...
                <select
                  ...
                  className="mt-1.5 block w-full rounded-lg border border-outline-variant/30 bg-surface-container-low px-3 py-2.5 text-sm text-on-surface focus:border-primary/50 focus:ring-1 focus:ring-primary/20"
                >
                  {sources.map((source) => (
              ...
              {selectedSource ? (
                <div className="rounded-lg border border-outline-variant/15 bg-surface-container-low p-3">
                  <div className="text-sm font-semibold text-on-surface">{selectedSource.display_name}</div>
                  <div className="mt-1 text-xs font-mono text-on-surface-variant break-all">
                    {selectedSource.target_identifier}
                  </div>
                  <div className="mt-2 text-[10px] font-bold uppercase tracking-widest text-primary">
                    online · seen {relativeTime(selectedSource.last_seen_at)}
                  </div>
                </div>
              ) : null}
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <button
                  ...
                  className="rounded-lg bg-gradient-to-b from-primary to-primary-dim px-5 py-2.5 text-xs font-bold uppercase tracking-wider text-on-primary shadow-sm transition-all hover:brightness-110 hover:shadow-md disabled:cursor-not-allowed disabled:opacity-40"
                >

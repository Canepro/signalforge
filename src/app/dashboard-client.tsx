        ...
        <main className="flex-1 overflow-y-auto p-4 lg:p-6 space-y-6">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-gradient-to-b from-primary to-primary-dim text-on-primary text-sm font-semibold rounded-lg hover:opacity-90 shadow-md"
              title="Copy commands to collect outside SignalForge, then submit"
            >
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-[10px] text-on-surface-variant">
                      Copy CLI and collector commands
                    </p>
                  </div>
                </button>
                {runs.length > 0 ? (

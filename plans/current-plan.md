...
- Remaining hardening follow-on in `signalforge-agent`: richer install ergonomics for container-capable and Kubernetes-capable runners, and explicit non-laptop deployment guidance for Kubernetes-capable environments.

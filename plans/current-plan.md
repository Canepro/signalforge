...
- Phase 8 next-step prep remains in place in [phase-8-containers-k8s.md](/home/vincent/src/signalforge/plans/phase-8-containers-k8s.md). The artifact-envelope gate remains locked to the text-carried `kubernetes-bundle.v1` manifest.

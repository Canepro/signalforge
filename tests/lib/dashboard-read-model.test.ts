...
function mkSource(overrides: Partial<SourceView> = {}): SourceView {
  return {
    ...
    automation_enabled: overrides.automation_enabled ?? false,
    auto_fix_enabled: overrides.auto_fix_enabled ?? false,
    allowed_fix_policy_ids: overrides.allowed_fix_policy_ids ?? [],
